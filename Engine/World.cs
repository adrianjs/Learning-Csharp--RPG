...
namespace Engine
{
    public static class World
    {
        ...
        public const int QUEST_ID_CLEAR_ALCHEMICAL_GARDEN = 1;
        ...
        private static void PopulateQuests()
        {
            Quest clearAlchemistGarden = 
                new Quest(
                    QUEST_ID_CLEAR_ALCHEMICAL_GARDEN,
        ...
        private static void PopulateLocations()
        {
            ...
            alchemistHut.QuestAvailableHere = QuestByID(QUEST_ID_CLEAR_ALCHEMICAL_GARDEN);
