...
namespace SuperAdventure
{
    public partial class SuperAdventure : Form
    {
        ...
        private void MoveTo(Location newLocation)
        {
            ...
            if (newLocation.QuestAvailableHere != null)
            {
                ...
                if (playerAlreadyHasQuest)
                {
                    ...
                    {
                        //Check if player has all items required to complete the quest
        ...
        private void UpdateQuestListInUI()
        {
            ...
            {
                dgvQuests.Rows.Add(new[] { pq.QuestDetails.Name, pq.IsCompleted.ToString() });
            }
        }
        ...
        private void UpdateWeaponListInUI()
        {
            ...
            if (weapons.Count == 0)
            {
                //The player doesn't have any weapons, so hide combobox and use button
                cboWeapons.Visible = false;
                btnUseWeapon.Visible = false;
            }
            else
        ...
        private void UpdatePotionListInUI()
        {
            ...
            {
                //The player doesn't have any potions, so hide combobox and use button
                cboPotions.Visible = false;
                btnUsePotion.Visible = false;
            }
            else
        ...
        private void btnUseWeapon_Click(object sender, EventArgs e)
        {
            ...
            //Apply the damage to the monster's cHP
            ...
            if (_currentMonster.CurrentHitPoints <= 0)
            {
                ...
                //Give player exp for killing the monster
                ...
                foreach (InventoryItem inventoryItem in lootedItems)
                {
                    ...
                    {
                        rtbMessages.Text += "You loot " + inventoryItem.Quantity.ToString() + " " + inventoryItem
                                                .Details
            ...
            else
            {
                ...
                //Determine the amont of damage the monster does to the player
        ...
        private void btnUsePotion_Click(object sender, EventArgs e)
        {
            ...
            //cHP cannot exceed player's max HP
